...
while not done:
        ...
        if x_val >= size[0] - (padd_width) and y_val < y_padd2 + padd_width and y_val > y_padd2 - padd_width:
                x_direction += -1
        # endif
        ...
        draw_text(screen, str(score_left), 50, 300, 10)
        draw_text(screen, str(score_right), 50, 320,10)
